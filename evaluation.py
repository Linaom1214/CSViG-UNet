...
def parse_args():
    ...
    # Network parameters
    #
    parser.add_argument('--pkl-path', type=str, default=r'result/sirstaug/2023-05-15_20-28-39_transformer/checkpoint/Iter-10040_mIoU-0.7513_fmeasure-0.8580.pkl',
                        help='checkpoint path')
    parser.add_argument('--net-name', type=str, default='gnn',
                        help='net name: fcn')
